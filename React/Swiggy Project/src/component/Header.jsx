    ...
    <>
      <div className="bg-[#ff5200] h-screen w-full relative">
        <div className="w-screen p-4 flex justify-evenly items-center h-[80px] absolute top-6">
          ...
          <div className="flex justify-center items-center gap-12">
            <a
              ...
              className="outline-none text-white font-bold text-xl"
            >
              Swiggy Corporate
            </a>
            <a
            ...
            <button
              ...
              className="border cursor-pointer border-white rounded-xl h-[55px] w-[150px] text-white font-bold text-lg"
            >
              Get the app
            </button>
            <button className="text-white bg-black rounded-xl h-[55px] w-[140px] font-bold text-xl">
              Sign in
            </button>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center absolute bottom-10 left-1/2 transform -translate-x-1/2 gap-4">
          <Link className="block w-[400px] h-[350px]" to="restaurants">
            <img
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            className="block w-[400px] h-[350px]"
